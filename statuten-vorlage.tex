...
name=Obfrau / Obmann,
user1=die Obfrau / der Obmann,
user2=der Obfrau / des Obmanns,
user3=der Obfrau / dem Obmann,
user4=die Obfrau / den Obmann}

\newglossaryentry{schrift}{description=,
name=Schriftführerin / Schriftführer,
user1=die Schriftführerin / der Schriftführer,
user2=der Schriftführerin / des Schriftführers,
user3=der Schriftführerin / dem Schriftführer,
user4=die Schriftführer / den Schriftführer}

\newglossaryentry{kassa}{description=,
name=Kassierin / Kassier,
user1=die Kassierin / der Kassier,
user2=der Kassierin / des Kassiers,
user3=der Kassierin / dem Kassier,
user4=die Kassierin / den Kassier}

% Achtung 1, Genitiv ohne bestimmte Artikel!
% Achtung 2, separater Eintrag für Pluralform!
\newglossaryentry{repruef}{description=,
name=Rechnungsprüferin / Rechnungsprüfer,
plural=Rechnungsprüferinnen /Rechnungsprüfer,
user2=Rechnungsprüferin / Rechnungsprüfers,
user3=der Rechnungsprüferin / dem Rechnungsprüfer,
user4=die Rechnungsprüferin / den Rechnungsprüfer}

% Plural für \gls{repruef}
\newglossaryentry{repruef-pl}{description=,
name=Rechnungsprüferinnen / Rechnungsprüfer,
user3=den Rechnungsprüferinnen / den Rechnungsprüfern
user4=die Rechnungsprüferinnen / die Rechnungsprüfer}

\newglossaryentry{stv}{description=,
name=Stellvertreterin / Stellvertreter,
plural=Stellvertreterinnen / Stellvertreter,}

\newglossaryentry{gruend}{description=,
name=die Gründerinnen / die Gründer,}


\newglossaryentry{schiri}{description=,
name=Schiedsrichterin / Schiedsrichter,
plural=Schiedsrichterinnen / Schiedsrichter}

% Achtung, Genitiv ohne bestimmten Artikel!
\newglossaryentry{kura}{description=,
name=Kuratorin / Kurator,
user2=Kuratorin / Kurators}
...
\begin{absatz}
    ...
    \begin{littera}
        ...
        \item \label{aogv-rp-beschluss} Beschluss der \glspl{repruef} /einer bzw. eines \glsuserii{repruef} (§ 21 Abs. 5 zweiter Satz VereinsG, § \ref{vorstand} Abs. \ref{vorstand-wahl} dritter Satz dieser Statuten),
        \item \label{aogv-kurator} Beschluss eines / einer gerichtlich bestellten \glsuserii{kura} (§ \ref{vorstand} Abs. \ref{vorstand-wahl} letzter Satz dieser Statuten)
    \end{littera}
    ...
    \item Den Vorsitz in der Generalversammlung führt \glsuseri{obmensch}, in dessen/deren Verhinderung sein/e/ihr/e \gls{stv}. Wenn auch diese/r verhindert ist, so führt das an Jahren älteste anwesende Vorstandsmitglied den Vorsitz.
\end{absatz}
...
\begin{absatz}
    ...
    % zB zwei oder vier Jahre (abgestimmt auf den Abstand zwischen ordentlichen Generalversammlungen nach § 9 Abs 1).
     ...
     \item Der Vorstand wird von \glsuseriii{obmensch}, bei Verhinderung von seinem/seiner/ihrem/ihrer \gls{stv}, schriftlich oder mündlich einberufen. Ist auch diese/r auf unvorhersehbar lange Zeit verhindert, darf jedes sonstige Vorstandsmitglied den Vorstand einberufen.
     ...
     \item Den Vorsitz führt \glsuseri{obmensch}, bei Verhinderung sein/e/ihr/e \gls{stv}. Ist auch diese/r verhindert, obliegt der Vorsitz dem an Jahren ältesten anwesenden Vorstandsmitglied oder jenem Vorstandsmitglied, das die übrigen Vorstandsmitglieder mehrheitlich dazu bestimmen.
