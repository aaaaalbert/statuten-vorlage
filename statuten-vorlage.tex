...
\newglossaryentry{obmensch}{name=Obfrau / Obmann,description=}
\newglossaryentry{obmensch1}{name=die Obfrau / der Obmann,description=}
\newglossaryentry{obmensch2}{name=der Obfrau / des Obmanns,description=}
\newglossaryentry{obmensch3}{name=der Obfrau / dem Obmann,description=}
\newglossaryentry{obmensch4}{name=die Obfrau / den Obmann,description=}

\newglossaryentry{schrift}{name=Schriftführerin / Schriftführer,description=}
\newglossaryentry{schrift1}{name=die Schriftführerin / der Schriftführer,description=}
\newglossaryentry{schrift2}{name=der Schriftführerin / des Schriftführers,description=}
\newglossaryentry{schrift3}{name=der Schriftführerin / dem Schriftführer,description=}
\newglossaryentry{schrift4}{name=die Schriftführer / den Schriftführer,description=}

\newglossaryentry{kassa}{name=Kassierin / Kassier,description=}
\newglossaryentry{kassa1}{name=die Kassierin / der Kassier,description=}
\newglossaryentry{kassa2}{name=der Kassierin / des Kassiers,description=}
\newglossaryentry{kassa3}{name=der Kassierin / dem Kassier,description=}
\newglossaryentry{kassa4}{name=die Kassierin / den Kassier,description=}

\newglossaryentry{repruef}{name=Rechnungsprüferin / Rechnungsprüfer,plural=Rechnungsprüferinnen / Rechnungsprüfer,description=}
\newglossaryentry{repruef2*}{name=Rechnungsprüferin / Rechnungsprüfers,description=}
\newglossaryentry{repruef3}{name=der Rechnungsprüferin / dem Rechnungsprüfer,plural=den Rechnungsprüferinnen / den Rechnungsprüfern,description=}
\newglossaryentry{repruef4}{name=die Rechnungsprüferin / den Rechnungsprüfer,plural=die Rechnungsprüferinnen / die Rechnungsprüfer,description=}


\newglossaryentry{stv}{name=Stellvertreterin / Stellvertreter,plural=Stellvertreterinnen / Stellvertreter,description=}

\newglossaryentry{gruend1}{name=die Gründerinnen / die Gründer,description=}


\newglossaryentry{schiri}{name=Schiedsrichterin / Schiedsrichter,plural=Schiedsrichterinnen / Schiedsrichter,description=}

\newglossaryentry{kura}{name=Kuratorin / Kurator,description=}
\newglossaryentry{kura2*}{name=Kuratorin / Kurators,description=}
